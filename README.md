# slack OpenAPI Specification
[![Build Status](https://travis-ci.org/kenneth-lau/slack-api-docs.svg?branch=master)](https://travis-ci.org/kenneth-lau/slack-api-docs)
...
6. If you did everything correct, https://kenneth-lau.github.io/slack-api-docs/ will lead to your new docs
...
- Documentation(ReDoc): https://kenneth-lau.github.io/slack-api-docs/
...
- Preview spec version for branch `[branch]`: https://kenneth-lau.github.io/slack-api-docs/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://kenneth-lau.github.io/slack-api-docs/ with url from the message: `Server started <url>`
